...
class IncomePaidController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'user_id', 'income_type_id', 'price', 'type', 'description', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'user_id', 'income_type_id', 'price', 'type', 'description', 'create_by');
