...
class WorkAdsController extends Controller
{
    public function getList()
    {
        $Item = WorkAds::get()->toarray();
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'user_id', 'price', 'time_start', 'time_end', 'description', 'image', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'user_id', 'price', 'time_start', 'time_end', 'description', 'image', 'create_by');

        $D = WorkAds::select($col);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->image && $request->image != null && $request->image != 'null') {
                $Item->image = $this->uploadImage($request->image, '/images/work_ads/');
            }
     ...
     *
     * @param  \App\Models\WorkAds  $workAds
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        $Item = WorkAds::find($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(WorkAds $workAds)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, WorkAds $workAds)
    {
        //
    }
